...
def execute():
    ...
    # 出力先ワークブック指定
    wbc = WorkbookControl(target='./tests/temp/o3o1o0_word_chain_game_Drive.xlsx', mode='w', settings={
        # その他の操作
    ...
    WorksheetDumpControl.dump(worksheet=wbc._ws, file='./tests/temp/actual/o3o1o0_word_chain_game_Drive.txt')     # テスト用
