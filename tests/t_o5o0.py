...
def execute():
    ...
    with tr.prepare_workbook(target='./tests/temp/test_o5o0_multiple_root_by_table.xlsx', mode='w') as b:
        ...
        with b.prepare_worksheet(target='Shiritori', based_on='./examples/data/multiple_root_by_table.csv') as s:
            ...
            # ワークシートへ木構造図を描画
            s.render_tree()
            WorksheetDumpHandle.dump(worksheet=s._ws, file='./tests/diff_dump/actual/test_o5o0_multiple_root_by_table_Shiritori.txt')     # テスト用
