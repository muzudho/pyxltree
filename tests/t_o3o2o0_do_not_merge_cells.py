...
def execute():
    ...
    # 出力先ワークブック指定
    wbc = tr.prepare_workbook(target='./tests/temp/test_o3o2o0_do_not_merge_cells.xlsx', mode='w', settings={
        # その他の操作
    ...
    WorksheetDumpControl.dump(worksheet=wbc._ws, file='./tests/diff_dump/actual/test_o3o2o0_do_not_merge_cells.txt')     # テスト用
